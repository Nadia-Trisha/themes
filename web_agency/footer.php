        ...
        <div class="row">
          <div class="col-md-3">
            <div class="info_contact">
              ...
              <div>
                <div class="img-box">
                  <img src="<?php echo get_template_directory_uri(); ?>/images/location-white.png" width="18px" alt="" />
                </div>
                <p>Address</p>
              </div>
              <div>
                <div class="img-box">
                  <img src="<?php echo get_template_directory_uri(); ?>/images/telephone-white.png" width="12px" alt="" />
                </div>
                <p>+01 1234567890</p>
              </div>
              <div>
                <div class="img-box">
                  <img src="<?php echo get_template_directory_uri(); ?>/images/envelope-white.png" width="18px" alt="" />
                </div>
                <p>demo@gmail.com</p>
              </div>
            </div>
